...
class LargeFragment : SupportFragment() {
    ...
    class B(context: Context, list: List<Image>) : RecyclerAdapter<Image, ItemImageLargeDiyBinding>(context, list, R.layout.item_image_large_diy) {
        override fun onBind(holder: RecyclerHolder<ItemImageLargeDiyBinding>?, t: Image?, position: Int) {
            Observable.just(0)
